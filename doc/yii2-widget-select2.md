...
**yii2-widget-select2** is released under the BSD 3-Clause License. See the bundled [`LICENSE.md`](https://github.com/kartik-v/yii2-widget-select2/blob/master/LICENSE.md) for details.